...
_fallback_db = {
    ...
    "testimonials": [
        ...
        {"id": 2, "name": "The Adhikari Family", "location": "Mumbai, India", "destination": "River Streams & Valley, Munnar", "avatar": "/assets/munnar_river_family.jpg", "avatar_initials": "AF", "rating": 5,
         "quote": "Pristine river streams, lush green forests, and unforgettable moments. Pranara made us feel like family while delivering an ultra-luxurious experience.", "videoUrl": ""},
        {"id": 3, "name": "Mr. & Mrs. Sharma", "location": "Delhi, India", "avatar_initials": "MS", "rating": 5,
        ...
        {"id": 4, "name": "Sarah, Aman, Roshni & Amit", "location": "Pune, Mumbai", "destination": "Chokkarmudi Summit Trek", "avatar": "/assets/munnar_chokkarmudi_trek.jpg", "avatar_initials": "SAR", "rating": 5,
         "quote": "Standing above the clouds at Chokkarmudi Peak was surreal! It was more than just a trek—it was a soulful journey through untouched wilderness.", "videoUrl": "/assets/Review.mp4"},
        {"id": 5, "name": "Amal & Friends", "location": "Chennai, India", "avatar_initials": "AF", "rating": 5,
...
def handle_testimonials():
    ...
    testimonial = {
        ...
        "destination": (data.get("destination") or "").strip() or "Kerala Experience",
        "tagline": (data.get("tagline") or "").strip().upper() or "GUEST REVIEW",
        "avatar": data.get("avatar") or "/assets/logo.png",
        "avatar_initials": initials,
        "rating": rating,
        "quote": quote,
        "videoUrl": data.get("videoUrl") or data.get("video_url") or "",
        "active": True,
