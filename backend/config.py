...
class Config:
    ...
    # CORS
    CORS_ORIGINS = os.getenv("CORS_ORIGINS", "http://localhost:5173,http://localhost:5174,http://localhost:3000,https://pranara-tours.vercel.app,https://pranara13.vercel.app")
