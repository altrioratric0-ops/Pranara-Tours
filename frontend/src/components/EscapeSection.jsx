      ...
      {selectedPackage && (
        <div className="package-modal-overlay" onClick={() => setSelectedPackage(null)}>
          <div className="package-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            {/* Modal Actions */}
            <div className="package-modal-actions" style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              <a
                href={`https://wa.me/916374502007?text=${encodeURIComponent(`Hi Pranara! I would like to enquire about booking the experience: ${selectedPackage.title}`)}`}
                target="_blank"
