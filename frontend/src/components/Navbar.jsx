          ...
          <div className="navbar-footer">
            ...
            <div className="navbar-bottom">
              <div className="navbar-socials">
                <a href={`https://wa.me/916374502007?text=${encodeURIComponent('Hello Pranara Travel Co.! I would like to inquire about your Kerala tour packages and customized itineraries.')}`} target="_blank" rel="noreferrer" aria-label="WhatsApp">
