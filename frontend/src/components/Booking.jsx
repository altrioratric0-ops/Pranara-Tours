          ...
          <div className="community-content-left">
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              >
                ...
                ENQUIRE NOW VIA WHATSAPP (+91 6374502007)
              </button>
            </div>

            {/* Join Community Input Form */}
            <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px stroke rgba(0,0,0,0.08)' }}>
              <p style={{ fontSize: '0.85rem', color: 'var(--text-light)', marginBottom: '10px', fontWeight: 600 }}>
                Or enter mobile number to receive travel deals on WhatsApp:
              </p>
