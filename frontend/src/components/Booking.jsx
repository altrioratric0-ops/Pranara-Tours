        ...
        <div className="booking-grid">
          <div className="booking-info">
            ...
            <div className="contact-detail">
              ...
              <span>Contact: <a href="tel:+917397532574" style={{ color: 'inherit', fontWeight: 'bold' }}>+91 73975 32574</a></span>
            </div>
            <div className="contact-detail">
              <div className="icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <span>WhatsApp: <a href="https://wa.me/917397532574" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', fontWeight: 'bold' }}>+91 73975 32574</a></span>
            </div>
            <div className="contact-detail">
              <div className="icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div style={{ marginTop: '28px', display: 'flex', gap: '14px', flexWrap: 'wrap', alignItems: 'center' }}>
              <a
                href="https://wa.me/917397532574?text=Hi%20Pranara,%20I'm%20interested%20in%20booking%20a%20Kerala%20trip!"
                target="_blank"
