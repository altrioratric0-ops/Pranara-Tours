        ...
        <div className="footer-grid-5col">
          ...
          <div className="footer-col-brand">
            ...
            <div className="footer-social-circles">
              ...
              <a href={`https://wa.me/916374502007?text=${encodeURIComponent('Hello Pranara Travel Co.! I would like to inquire about your tour packages and travel itineraries.')}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-btn">
