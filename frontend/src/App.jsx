...
function App() {
  ...
  return (
    <div className="app">
      ...
      >
        <svg viewBox="0 0 24 24" className="instagram-icon" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
